...
@Component({
  ...
  styleUrls: ['./nivel-atencion.component.scss']
})
export class NivelAtencionComponent implements OnInit {
...
this._solicitudesService.consultarSolicitudesBuzonPendiente('CACI').subscribe(
(response) =>{
...
this.router.navigate(['/nivelcaci/asignarSolicitud']); 
