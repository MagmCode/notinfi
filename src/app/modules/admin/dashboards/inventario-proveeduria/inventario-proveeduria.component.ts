...
@Component({
  selector: 'app-inventario-proveeduria',
  templateUrl: './inventario-proveeduria.component.html',
  styleUrls: ['./inventario-proveeduria.component.scss']
})
export class InventarioProveeduriaComponent implements OnInit {
  user = {} as User;
  usuario = {} as any;
 //#region  tablas
...
this._solicitudesService.consultarSolicitudesBuzonPendiente('INVENTARIO-PROVEEDURIA').subscribe(
(response) =>{
...
this.router.navigate(['/inventario-proveeduria/asignarSolicitud']); 
