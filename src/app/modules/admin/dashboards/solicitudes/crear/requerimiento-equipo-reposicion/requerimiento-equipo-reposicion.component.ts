...
import { DatosReposicionComponent } from '../datos-reposicion/datos-reposicion.component';

@Component({
  selector: 'app-requerimiento-equipo-reposicion',
  templateUrl: './requerimiento-equipo-reposicion.component.html',
  styleUrls: ['./requerimiento-equipo-reposicion.component.scss']
})
export class RequerimientoEquipoReposicionComponent implements OnInit {
...
openDialog(codUsuarioI : string) {
  const dialogRef = this.dialog.open(DatosReposicionComponent,{
