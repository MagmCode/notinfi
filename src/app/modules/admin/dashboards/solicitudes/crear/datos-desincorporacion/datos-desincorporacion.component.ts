...
@Component({
  selector: 'app-datos-desincorporacion',
  templateUrl: './datos-desincorporacion.component.html',
  styleUrls: ['./datos-desincorporacion.component.scss']
})
export class DatosDesincorporacionComponent implements OnInit {
...
@ViewChild(MatSort) sort: MatSort = new MatSort; 
 //#endregion
  ...
  constructor(public dialogRef: MatDialogRef<DatosDesincorporacionComponent>,
