...
@Component({
  selector: 'app-buzon-pendiente',
  templateUrl: './buzon-pendiente.component.html',
  styleUrls: ['./buzon-pendiente.component.scss']
})
export class BuzonPendienteComponent implements OnInit {
