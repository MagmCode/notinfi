...
@Component({
  selector: 'app-reasignar-solicitudinv',
  templateUrl: './reasignar-solicitudinv.component.html',
  styleUrls: ['./reasignar-solicitudinv.component.scss']
})
export class ReasignarSolicitudinvComponent implements OnInit {
  user = {} as User;
  usuario = {} as any;
