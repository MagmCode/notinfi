...
@Component({
  selector: 'app-buzon-pendiente-sop',
  templateUrl: './buzon-pendiente-sop.component.html',
  styleUrls: ['./buzon-pendiente-sop.component.scss']
})
export class BuzonPendienteSopComponent implements OnInit {
...
//#endregion
  ...
  async obtenerPlantilla(){
    ...
    this._solicitudesService.consultarSolicitudesBuzonPendiente('SOPORTE').subscribe(
    (response) =>{
  ...
  this.router.navigate(['/soporte/asignarSolicitud']); 
