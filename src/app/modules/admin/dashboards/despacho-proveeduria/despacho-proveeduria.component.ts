...
@Component({
  selector: 'app-despacho-proveeduria',
  templateUrl: './despacho-proveeduria.component.html',
  styleUrls: ['./despacho-proveeduria.component.scss']
})
export class DespachoProveeduriaComponent implements OnInit {
...
this._solicitudesService.consultarSolicitudesBuzonPendiente('DESPACHO').subscribe(
(response) =>{
...
this.router.navigate(['/despacho-proveeduria/asignarSolicitud']); 
