...
// import { OfertaInterbancaria } from 'app/models/mesa-cambio';
...
export class OfertaInterbancariaMesaCambioComponent implements OnInit {
  ...
  //   'ID': 'ID Operación',
  //   'TIPO_OPER': 'Tipo OfertaInterbancaria',
  //   'RIF_CLIENTE': 'Cédula/RIF',
  //   'NOMBRE_CLIENTE': 'Cliente',
  //   'CODIGO_MONEDA_ENT': 'Moneda Ent',
  //   'MONTO_ENT': 'Monto Ent',
  //   'CODIGO_MONEDA_REC': 'Moneda Rec',
  //   'MONTO_REC': 'Monto Rec',
  //   'MONTO_REC_BCV': 'Monto Rec BCV',
  //   'TIPO_INSTRU_ENT': 'Instrumento Ent',
  //   'FECHA': 'Fecha',
  //   'TIPO_INSTRU_REC': 'Instrumento Rec',
...
//#region Variables
  ...
  // selection = new SelectionModel<OfertaInterbancaria>(true, []);
  ...
  //   'select', 'ID', 'TIPO_OPER', 'RIF_CLIENTE', 'NOMBRE_CLIENTE', 'CODIGO_MONEDA_ENT', 'MONTO_ENT', 'CODIGO_MONEDA_REC', 'MONTO_REC',
  //   'MONTO_REC_BCV', 'TIPO_INSTRU_ENT', 'FECHA', 'TIPO_INSTRU_REC', 'OBSERVACION', 'ESTATUS', 'ID_JORNADA', 'ID_BCV'
  // ];
  ...
  // dataSourceH: MatTableDataSource<OfertaInterbancaria>;
  // OfertaInterbancaria: OfertaInterbancaria[] = [
  //   {
  //     ID: 1,
  //     TIPO_OPER: 'C',
  //     TIPO_PER: 'N',
  ...
  //     CODIGO_MONEDA_ENT: 'USD',
  //     MONTO_ENT: 10000.50,
  //     TIPO_INSTRU_ENT: 'BOND',
  //     FECHA: '11/09/2025',
  //     CUENTA_ME_ENT: '0102-1234567890',
  //     CUENTA_MN_ENT: '0102-0987654321',
  //     CODIGO_MONEDA_REC: 'EUR',
  //     MONTO_REC: 9500.00,
  //     TIPO_INSTRU_REC: 'ACC',
  //     CUENTA_ME_REC: '0102-2233445566',
  //     CUENTA_MN_REC: '0102-6655443322',
  //     MONTO_REC_BCV: 9400.00,
  //     MONTO_CANJE_BASE: 9800.00,
  //     TIPO_PACTO: 'OfertaInterbancaria',
  ...
  //     CODIGO_MONEDA_ENT: 'EUR',
  //     MONTO_ENT: 5000.75,
  //     TIPO_INSTRU_ENT: 'ACC',
  //     FECHA: '11/09/2025',
  //     CUENTA_ME_ENT: '0102-2233445566',
  //     CUENTA_MN_ENT: '0102-6655443322',
  //     CODIGO_MONEDA_REC: 'USD',
  //     MONTO_REC: 4800.00,
  //     TIPO_INSTRU_REC: 'BOND',
  //     CUENTA_ME_REC: '0102-1234567890',
  //     CUENTA_MN_REC: '0102-0987654321',
  //     MONTO_REC_BCV: 4700.00,
  //     MONTO_CANJE_BASE: 4900.00,
  //     TIPO_PACTO: 'OfertaInterbancaria',
  ...
  {
    // this.dataSourceH = new MatTableDataSource(this.OfertaInterbancaria); 
  }
  ...
  //   if (event.index === 0) {
  //     localStorage.removeItem('operacionesOfertaInterbancariaBusqueda');
  //     localStorage.removeItem('operacionesOfertaInterbancariaResultados');
  //     localStorage.removeItem('operacionesOfertaInterbancariaCantidad');
  //     localStorage.removeItem('operacionesOfertaInterbancariaTotal');
  //     localStorage.removeItem('operacionesOfertaInterbancariaJornada');
  //     this.dataSourceH = new MatTableDataSource([]);
  // this.OfertaInterbancaria = [];
  //     this.cantidad = '';
  //     this.total = '';
  //     this.jornada = '';
  //   }
   ...
   */
  ngOnInit(): void {
  //   const savedBusqueda = localStorage.getItem('operacionesOfertaInterbancariaBusqueda');
  //   if (savedBusqueda) {
  //     const busqueda = JSON.parse(savedBusqueda);
  //     this.operaOfertaInterbancariaForm = this._formBuilder.group({
  //       jornada: [busqueda.jornada, [Validators.required]],
  //       movimiento: [busqueda.movimiento],
  //     });

  //     // Recupera los resultados guardados
  //     const savedResultados = localStorage.getItem('operacionesOfertaInterbancariaResultados');
  //     if (savedResultados) {
  ...
  // this.OfertaInterbancaria = safeResultados;
  ...
  //     const savedCantidad = localStorage.getItem('operacionesOfertaInterbancariaCantidad');
  //     if (savedCantidad) {
  //       this.cantidad = JSON.parse(savedCantidad);
  //     }
  //     const savedTotal = localStorage.getItem('operacionesOfertaInterbancariaTotal');
  //     if (savedTotal) {
  //       this.total = JSON.parse(savedTotal);
  //     }
  //     const savedJornada = localStorage.getItem('operacionesOfertaInterbancariaJornada');
  //     if (savedJornada) {
  ...
  //     this.operaOfertaInterbancariaForm = this._formBuilder.group({
  //       jornada: [''],
  //       movimiento: ['Pactos', [Validators.required]],
  //     });
   ...
   */
  consultarOfertaInterbancaria() {
    this.isLoading = true;
    if (this.operaOfertaInterbancariaForm.controls['fechOper'].invalid) {
    ...
    this.selectedTabIndex = 1;
    this.canViewTab = true;
  // this.cantidad = this.OfertaInterbancaria.length.toString();
  // this.total = this.OfertaInterbancaria.reduce((acc, curr) => acc + (curr.MONTO_ENT || 0), 0).toString();
   ...
   */
  // onCheckboxChange(event: MatCheckboxChange, row: OfertaInterbancaria) {
  //   if (event.checked) {
...
//   const formFecha = this.operaOfertaInterbancariaForm.get('fechOper')?.value;
...
exportarExcel(): void {
    ...
    this.exportProgressService.iniciarProgreso(
      ...
      () =>  this._service.exportarIntervencion('OfertaInterbancariaFiltroExportar', this.operaOfertaInterbancariaForm.value)
    );
}
...
// }
  ...
  regresar(): void {
    ...
    this.canViewTab = false;
    this.operaOfertaInterbancariaForm.reset();
    // Asigna la fecha del día nuevamente
    const today = new Date();
    this.operaOfertaInterbancariaForm.get('fechOper')?.setValue(today);
