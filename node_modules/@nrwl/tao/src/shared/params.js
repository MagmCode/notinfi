...
exports.lookupUnmatched = exports.convertSmartDefaultsIntoNamedParams = exports.warnDeprecations = exports.combineOptionsForGenerator = exports.combineOptionsForExecutor = exports.applyVerbosity = exports.setDefaults = exports.validateObject = exports.validateOptsAgainstSchema = exports.SchemaError = exports.convertAliases = exports.coerceTypesInOptions = exports.convertToCamelCase = exports.handleErrors = void 0;
...
function convertAliases(opts, schema, excludeUnmatched) {
    return Object.keys(opts).reduce((acc, k) => {
        if (schema.properties[k]) {
            ...
            const found = Object.entries(schema.properties).find(([_, d]) => d.alias === k || (Array.isArray(d.aliases) && d.aliases.includes(k)));
            if (found) {
                acc[found[0]] = opts[k];
            }
